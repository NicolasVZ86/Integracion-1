...
console.error('Error al agregar al carrito:', error);
  ...
  function eliminarDelCarrito(productoID) {
    try {
      ...
      var productoEnCarrito = carrito.find(p => p.ID === productoID);
  
      if (productoEnCarrito) {
        if (productoEnCarrito.Cantidad > 1) {
          productoEnCarrito.Cantidad--;
        } else {
          var indice = carrito.indexOf(productoEnCarrito);
        ...
        console.log('Producto actualizado con éxito en el carrito');
      } else {
